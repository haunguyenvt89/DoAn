<%-- 
    Document   : menu-page-admin
    Created on : Jun 9, 2015, 1:23:13 PM
    Author     : SnsPlusVN_05
--%>
		...
		<ul class="nav navbar-nav navbar-right">
			<li class="dropdown"><a href="#"
				...
				<ul class="dropdown-menu">
					...
					<li><a href="user.html" class="menu-account-user">User</a></li>
				</ul></li>
			<li class="dropdown"><a href="#"
				...
				<ul class="dropdown-menu">
					...
					<li><a href="nhomCH.html" class="menu-cauhoi-nhomcauhoi">Nhóm
							câu hỏi</a></li>
					<li><a href="cauhoi.html" class="menu-cauhoi">Câu hỏi</a></li>
				</ul></li>
